...
/* Stepping a pending server-side TLS handshake (pending/advance/wants_write) is
 * declared in transport_handshake.h, not here — it's a server-poll-loop detail,
 * not part of this transport's general API. */
